...
My new appearance entered the public beta in summer 2024, and my transition reached a pre-release state in summer 2025.
I had been thinking whether it was something I wanted for years before that, and I am glad I had finally gotten around to it.
...
Zero regrets.
So much fun.
And I am appreciating literally every change.

I am rei-discovering so many things.
...
I recorded a bunch of videos from different stages in development:
...
Based on those, I wrote my own firmware ([ftvkyo/ggroohauga-rs][ftvkyo-ggroohauga-rs] on GitHub) for the ESP32-S3.
...
{{% details `More about the audio pipeline` %}}
...
Most of offsets and sizes are configurable, and interpolation is controlled by an assortment of easing functions.

I printed them out of PLA on my Ender 3V3 SE with a 0.25mm nozzle and 0.075mm layer height.
...
The company also appeared at multiple conferences and even got featured in [Business Insider][work-business-insider]!
...
### People and learning how they work
